#Please setwd() and path to the location where the folder T=0.01s is saved
...
dS2S_T001<-Kriging_g$var1.pred
AF_T001<-exp(Kriging_g$var1.pred)
var_T001<-Kriging_g$var1.var
sd_T001<-sqrt(Kriging_g$var1.var)
results <- cbind(lat,lon,dS2S_T001,AF_T001,var_T001,sd_T001)
write.csv(results, file.path(path,"OK_g_T001.csv"))
